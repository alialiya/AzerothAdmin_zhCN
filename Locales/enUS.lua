...
--[[Linkifier]]
    ...
    --Maps
    ["EasternKingdoms(N)"]               = "Eastern Kingdoms(N)",
    ["EasternKingdoms(S)"]               = "Eastern Kingdoms(S)",
}
end
...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"]                   = "|cffeda55f点击|r 打开面板 |cffeda55fShift-Click|r to reload the user interface.",
    ["tt_Default"]                    = "将光标移至某个元素上可切换工具提示！",
    ["tt_LanguageButton"]             = "重新加载", --Removed locals. Updated tooltip to just reload
  --[[Control Labels]]
    ["ma_LanguageButton"]             = "更改语言",
    ["info_revision"]                 = "|cFF00FF00AzerothCore版本:|r ", --Updated: Matched string output to AzerothAdmin
    ["info_platform"]                 = "|cFF00FF00服务器平台:|r ",
    ["info_online"]                   = "|cFF00FF00在线玩家:|r ",
    ["info_maxonline"]                = "|cFF00FF00最大在线:|r ",
    ["info_uptime"]                   = "|cFF00FF00时间:|r ",
    ["ma_CloseWindow"]                = "X",
    ["tt_CloseWindow"]                = "关闭面板",
  --[[Other]]
    ["slashcmds"]                     = { "/AzerothAdmin", "/aa" },
    ["lang"]                          = "中文",
    ["realm"]                         = "|cFF00FF00服务器:|r "..GetCVar("realmName"), --do not change this line!
    ["char"]                          = "|cFF00FF00角色名:|r "..UnitName("player"), --do not change this line!
    ["guid"]                          = "|cFF00FF00Guid:|r ",
    ["tickets"]                       = "|cFF00FF00Tickets:|r ",
    ["selectionerror1"]               = "请只选择您自己、其他玩家或不选择任何选项！",
    ["selectionerror2"]               = "请只选择您自己或不选择任何内容！",
    ["selectionerror3"]               = "请只选择另一名玩家！",
    ["selectionerror4"]               = "请只选择一名 NPC！",
    ["numbererror"]                   = "数值必须是数字！",
    ["searchResults"]                 = "|cFF00FF00搜索结果:|r ",
    ["ma_parameters"]                 = "参数(s):", --Used on multiple tabs
...
--[[GM tab]]
  ...
  --[[Tooltips]]
    ["tt_MainButton"]                 = "Toggle AzerothAdmins Mainframe.",
    ["tt_DisplayAccountLevel"]        = "显示账户等级",
    ["tt_GMOnButton"]                 = "激活 GM 模式",
    ["tt_GMOffButton"]                = "关闭 GM 模式",
    ["tt_FlyOnButton"]                = "激活所选角色的飞行模式",
    ["tt_FlyOffButton"]               = "Deactivate the Fly-mode for the selected character.",
    ["tt_HoverOnButton"]              = "Activate your Hover-mode.",
    ["tt_HoverOffButton"]             = "Deactivate your Hover-mode.",
    ["tt_WhispOnButton"]              = "Accept whispers from other players.",
  ...
  --[[Control Labels]]
    ["ma_OffButton"]                  = "关",
    ["ma_displaylevelbutton"]         = "显示账户等级",
    ["ma_GMOnButton"]                 = "GM模式 开",
    ["ma_FlyOnButton"]                = "飞行模式 开",
    ["ma_HoverOnButton"]              = "Hover-mode on",
    ["ma_WhisperOnButton"]            = "Whisper on",
    ["ma_InvisOnButton"]              = "Invisibility on",
    ["ma_TaxiOnButton"]               = "Cheat Taxi on",
    ...
    ["W"]                             = "W", --Abbreviation for West
    ["ma_chatbutton"]                 = "GM Chat On",
    ["ma_mapsbutton"]                 = "查看全部地图",
    ["ma_waterwalkbutton"]            = "Waterwalk On",
    ["ma_accountlockbutton"]          = "账户锁 开",
    ["ma_gmnotify"]                   = "GM通知",
    ["ma_gmingame"]                   = "在线GM",
    ["ma_gmlist"]                     = "GM名单",
    ["ma_petcreate"]                  = "Pet Create",
...
--[[Linkifier]]
    ...
    ["lfer_Error"]                    = "Error Search String Matched but an error occured or unable to find type",
    --Maps
    ["EasternKingdoms(N)"]                 = "东部王国(北)",
    ["EasternKingdoms(S)"]               = "东部王国(南)",
}
end
